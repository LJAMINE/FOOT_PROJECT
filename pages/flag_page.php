...
$myflags = mysqli_fetch_all($result, MYSQLI_ASSOC);
...
<body>
    ...
    <button id="ajouterclub"> add nation</button>

    <h1>list of nation</h1>

    <div class="container">
        <?php foreach ($myflags as $flag) { ?>
            <div class="card">
                <div class="card-header">
                    <span id="flag-name"><?php echo ($flag['flag_name']) ?></span>
                </div>
                <div class="card-body">
                    <img id="flag-logo" src="<?php echo $flag['url_flag']; ?>" alt="flag Logo">
                    <div class="btn">

                        <a href="edit_flag.php?id_flag=<?php echo $flag['id_flag']; ?>" style="text-decoration: none; color: inherit;">
                            <i class="fa-solid fa-pen-to-square" style="color: blue;"></i>
                        </a>

                        <form action="flag_page.php" method="POST">
                            <input type="hidden" name="id_to_delete" value="<?php echo $flag['id_flag']; ?>">
